...
const FeedingHistory: React.FC = () => {
  ...
  // Conexión a los Stores de Zustand
  ...
  return (
    <div className="flex h-full flex-col rounded-lg bg-white p-4 shadow-md gap-4">
      <h2 className="w-full bg-green-100 p-2 text-lg font-semibold text-gray-700 rounded-md">
      ...
      <div className="flex-shrink-0 border-t-2 border-gray-300 pt-3 text-right">
